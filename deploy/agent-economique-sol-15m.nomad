        ...
        data = <<EOH
{
  ...
  "state_file": "/root/data/backtest-optimizer/state/agent_eco_sol_15m.json",
  "database": {
        ...
        data = <<EOH
{
  ...
  "title": "Agent Eco SOL 15m",
  "ping_message": "🚀 SOL 15m Started",
  "signal_long": "🟢 LONG SOL 15m",
  "signal_short": "🔴 SHORT SOL 15m"
}
EOH
