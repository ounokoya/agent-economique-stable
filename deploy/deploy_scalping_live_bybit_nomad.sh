#!/bin/bash
# 🚀 Script de déploiement du job Nomad Scalping Live Bybit

set -e

# 🔧 CONFIGURATION NOMAD
NOMAD_ADDR="http://31.57.224.79:4646/"
NOMAD_TOKEN="1fc424de-5992-f4a5-c90e-cccabd7ef5d9"
CERTS_DIR="certs"
JOB_FILE="deploy/scalping-live-bybit.nomad"
...
echo -e "${BLUE}🚀 Déploiement Job Nomad Scalping Live Bybit${NC}"
echo "================================================="
echo "• Job: $JOB_NAME"
...
echo "  • Exchange: Bybit (sans restrictions géo)"
echo "  • Notifications: notifications.koyad.com/scalping-live-bybit"
...
echo "   2. S'abonner au topic: scalping-live-bybit"
