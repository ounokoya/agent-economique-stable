        ...
        data = <<EOH
{
  ...
  "state_file": "/root/data/backtest-optimizer/state/mfi_stoch_5m_extended.json",
  "database": {
    "url": "http://10.0.0.1:8529",
    "name": "agent_economique",
    "username": "root",
    "password": "agent_economique_2025",
    "collection_prefix": "mfi_stoch_5m"
  },
  "money_management": {
        ...
        data = <<EOH
{
  ...
  "topic": "mfi-stoch-5m",
  "title": "MFI+Stoch 5m Extended",
  "ping_message": "🚀 MFI+Stoch 5m Extended Started (SOLUSDT)",
  "signal_long": "🟢 LONG MFI+Stoch 5m",
  "signal_short": "🔴 SHORT MFI+Stoch 5m"
}
EOH
