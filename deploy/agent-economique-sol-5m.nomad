        ...
        data = <<EOH
{
  ...
  "state_file": "/root/data/backtest-optimizer/state/agent_eco_sol_5m.json",
  "database": {
        ...
        data = <<EOH
{
  ...
  "title": "Agent Eco SOL 5m",
  "ping_message": "🚀 SOL 5m Started",
  "signal_long": "🟢 LONG SOL 5m",
  "signal_short": "🔴 SHORT SOL 5m"
}
EOH
