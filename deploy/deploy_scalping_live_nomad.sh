#!/bin/bash
# 🚀 Script de déploiement du job Nomad Scalping Live
...
CERTS_DIR="certs"
JOB_FILE="deploy/scalping-live.nomad"
JOB_NAME="scalping-live"
...
echo -e "${BLUE}🚀 Déploiement Job Nomad Scalping Live${NC}"
echo "============================================="
echo "• Job: $JOB_NAME"
...
echo "  • Notifications: notifications.koyad.com/scalping-live"
